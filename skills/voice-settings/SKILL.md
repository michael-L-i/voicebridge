---
name: voice-settings
description: Choose Cadence Code's local speech and transcription models from the Codex UI. Use only when the user explicitly invokes $voice-settings or asks to open Cadence Code settings.
---
