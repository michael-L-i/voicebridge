...
Please use GitHub's **Report a vulnerability** form on the repository's
Security tab. This creates a private report that can be discussed and fixed
...
Do not include real voice recordings, transcripts, credentials, or other
personal data unless they are essential and have been carefully redacted.
...
For ordinary bugs and support questions, use the public issue tracker or GitHub
Discussions instead.
