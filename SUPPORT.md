...
conduct reports should follow [CODE_OF_CONDUCT.md](CODE_OF_CONDUCT.md).

This is a volunteer-maintained project. Support is best effort and does not
come with a guaranteed response time.
