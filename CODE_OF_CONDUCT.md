...
2. **Temporarily Limited Activities**
   ...
   - Consequence: A private, written warning with a time-limited cooldown
     period. The cooldown may be limited to particular channels or interactions.
   - Repair: Examples include making an apology, reflecting on actions and
     impact, and thoughtfully re-entering community spaces.
3. **Temporary Suspension**
   - Event: A pattern of repeated violation that warnings have not resolved, or
     a single serious violation.
   - Consequence: A private written warning with conditions for return from
     suspension.
   - Repair: Examples include respecting the suspension, meeting the conditions
     for return, and thoughtfully reintegrating with the community.
4. **Permanent Ban**
   - Event: A pattern of violations that other steps have failed to resolve, or
     a violation so serious that the community cannot otherwise be kept safe.
   - Consequence: Access to all community spaces, tools, and communication
     channels is removed.
   - Repair: There is no possible repair in cases of this severity.

This enforcement ladder is a guideline. It does not limit the discretion of
Community Moderators acting in the best interests of the community.
...
The enforcement ladder was inspired by
